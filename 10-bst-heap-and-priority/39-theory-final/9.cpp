...
3 3 1 7 7 4 4 5
max = 7
array = { 3, 3, 1, 7, 7, 4, 4, 5, }
count = { 0, 1, 0, 2, 2, 1, 0, 2, }
prefixarray = { 0, 1, 1, 3, 5, 6, 6, 8, }

step 1 :
output = { 0, 0, 0, 0, 0, 5, 0, 0, }
prefixarray = { 0, 1, 1, 3, 5, 5, 6, 8, }

step 2 :
output = { 0, 0, 0, 0, 4, 5, 0, 0, }
prefixarray = { 0, 1, 1, 3, 4, 5, 6, 8, }

step 3 :
output = { 0, 0, 0, 4, 4, 5, 0, 0, }
prefixarray = { 0, 1, 1, 3, 3, 5, 6, 8, }

step 4 :
output = { 0, 0, 0, 4, 4, 5, 0, 7, }
prefixarray = { 0, 1, 1, 3, 3, 5, 6, 7, }

step 5 :
output = { 0, 0, 0, 4, 4, 5, 7, 7, }
prefixarray = { 0, 1, 1, 3, 3, 5, 6, 6, }

step 6 :
output = { 1, 0, 0, 4, 4, 5, 7, 7, }
prefixarray = { 0, 0, 1, 3, 3, 5, 6, 6, }

step 7 :
output = { 1, 0, 3, 4, 4, 5, 7, 7, }
prefixarray = { 0, 0, 1, 2, 3, 5, 6, 6, }

step 8 :
output = { 1, 3, 3, 4, 4, 5, 7, 7, }
prefixarray = { 0, 0, 1, 1, 3, 5, 6, 6, }
